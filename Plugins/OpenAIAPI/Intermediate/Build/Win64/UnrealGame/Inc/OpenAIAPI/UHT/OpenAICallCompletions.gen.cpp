...
void FOnGptResponseRecievedPin_DelegateWrapper(const FMulticastScriptDelegate& OnGptResponseRecievedPin, TArray<FCompletion> const& completions, const FString& errorMessage, FCompletionInfo const& completionInfo, bool Success)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_2354068056(TEXT("/Script/OpenAIAPI"),
		Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
