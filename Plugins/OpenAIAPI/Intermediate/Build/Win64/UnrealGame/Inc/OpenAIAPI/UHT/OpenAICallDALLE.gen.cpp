...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls = { "generatedImageUrls", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OpenAIAPI_eventOnDalleResponseRecievedPin_Parms, generatedImageUrls), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_MetaData), Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_generatedImageUrls_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage = { "errorMessage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OpenAIAPI_eventOnDalleResponseRecievedPin_Parms, errorMessage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage_MetaData), Z_Construct_UDelegateFunction_OpenAIAPI_OnDalleResponseRecievedPin__DelegateSignature_Statics::NewProp_errorMessage_MetaData) };
...
void FOnDalleResponseRecievedPin_DelegateWrapper(const FMulticastScriptDelegate& OnDalleResponseRecievedPin, TArray<FString> const& generatedImageUrls, const FString& errorMessage, bool Success)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenAICallDALLE_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenAICallDALLE_OpenAICallDALLE, "OpenAICallDALLE" }, // 1164590418
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenAICallDALLE_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenAICallDALLE, UOpenAICallDALLE::StaticClass, TEXT("UOpenAICallDALLE"), &Z_Registration_Info_UClass_UOpenAICallDALLE, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenAICallDALLE), 1278842991U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallDALLE_h_361900447(TEXT("/Script/OpenAIAPI"),
		Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Ivan_Documents_Unreal_Projects_BachelorThesis_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallDALLE_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
